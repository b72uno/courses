...
# This time a four sided polygon
imshape = image.shape
# vertices = np.array([[(0, imshape[0]), (0,0), (imshape[1],0) (imshape[1], imshape[0])]], dtype=np.int32)
vertices = np.array([[(imshape[0]*0.1,imshape[0]),(imshape[1]*0.47, imshape[0]*0.45), (imshape[1]*0.53, imshape[0]*0.45), (imshape[1]*0.9,imshape[0])]], dtype=np.int32)
