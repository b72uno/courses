...
# Read in the ground truth map and create 3-channel green version for overplotting
# NOTE: images are read in by default with the origin (0,0) in the upper left
# and y-axis inreasing downward
ground_truth = mpimg.imread('../calibration_images/map_bw.png')
# Create arrays of zeros in the red and blue channels
# Put the map into the green channel. This is why the underlying
...
class RoverState():
    def __init__(self):
        ...
        # when you should stop. Feel free to modify.
        self.stop_forward = 50 # Threshold to initiate stopping
        self.go_forward = 500  # Threshold to go forward again
        self.max_vel = 6       # Maximum velocity m/s
...
def telemetry(sid, data):
    ...
    if data:
        ...
        if np.isfinite(Rover.vel):
            ...
            # In case of invalid telemetry, send null comands
        else:

            # Send zeros for throttle, brake and steer, and empty images
            send_control((0, 0, 0), '', '')

        # If you want to save camera images from autonomous driving,
        # specify a path, e.g. $ pthon drive_rover.py image_folder_path
...
if __name__ == '__main__':
    ...
    # wrap Flaskio application with socketio's middleware
